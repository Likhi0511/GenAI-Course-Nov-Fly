    ...
    for question in test_questions:
        ...
        if result:
            ...
            if result.get('context_used'):
                ...
                print(f"\n🗂️  Context Retrieved from S3 Vectors:")
                print("-" * 70)
                ...
                if context.get('columns'):
                    ...
                    for col in context['columns'][:5]:  # Show top 5
                        print(f"  • {col['table']}.{col['column']} (relevance: {col['relevance_score']})")
                ...
                if context.get('relationships'):
                    ...
                    for rel in context['relationships'][:3]:  # Show top 3
                        print(f"  • Relevance: {rel['relevance_score']}")
                ...
                if context.get('example_queries'):
                    ...
                    for i, example in enumerate(context['example_queries'], 1):
                        print(f"\n  Example {i} (relevance: {example['relevance_score']}):")
