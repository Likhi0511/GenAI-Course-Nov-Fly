...
def main():
    ...
    if not run_step("step1_deploy_stack.py", "Step 1: Deploy CloudFormation"):
    ...
    # if not run_step("step2_download_pdfs.py", "Step 2: Download Clinical Trials"):
    #     print("⚠️  Download failed!")
    #     print("Retry: python step2_download_pdfs.py")
