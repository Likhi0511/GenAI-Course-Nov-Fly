"""
core/config.py — Pipeline Configuration

Centralised configuration for the Ray Document Processing Pipeline.
All environment variables, resource limits, S3 prefixes, and API keys
are defined here as class attributes on PipelineConfig.
