...
from core.config import config  # Central config — reads env vars / Secrets Manager
from orchestration.dynamodb import (
    query_pending_documents,
    claim_document,
    update_document_status,
)

# NOTE: orchestration.tasks is imported INSIDE process_document() after ray.init() runs.
