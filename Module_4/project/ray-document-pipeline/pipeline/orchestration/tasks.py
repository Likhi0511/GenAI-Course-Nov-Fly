...
from stages.extract import process_pdf as bounded_process_pdf
...
from core.config    import config   # Central config — reads from env vars / Secrets Manager
from core.s3        import S3Helper
from core.workspace import LocalFileManager
from core.logging   import format_duration
