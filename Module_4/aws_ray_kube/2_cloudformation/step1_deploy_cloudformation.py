...
Creates: VPC, EKS Cluster, Node Group, IRSA, S3 Bucket, DynamoDB, Lambda, etc.
...
REGION        = "us-east-1"
TEMPLATE_FILE = "eks-cluster.yaml"
PARAMS_FILE   = "eks-parameters.json"
...
def main():
    ...
    if success:
        ...
        print("=" * 70 + "\n")
        print("Next: Run step1b_setup_eks.py  (installs KubeRay + deploys RayCluster)")
        print("      This is the EKS equivalent of the old ECS service startup.")
        print("      Then: step2_download_clinical_trials.py\n")
        sys.exit(0)
    else:
        print("\n❌ Step 1 Failed\n")
